...
export const SPEC_SECTION_INDEX: Record<string, { section: string; url: string; description: string }> = {
  ...
  "Iterator Protocol":       { section: "§27.1",  url: "https://tc39.es/ecma262/#sec-iteration", description: "Iterator and iterable protocols" },
  "Generator Protocol":      { section: "§27.5",  url: "https://tc39.es/ecma262/#sec-generator-objects", description: "Generator state machine" },
